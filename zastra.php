  ...
  <section>
    <div class="container_16">
      <section class="grid_16 box" id="what_is_zastra">
        ...
        <p>
          Zastra's vision: To build a complete, end-to-end knowledge ecosystem that caters to students, institutes, industry irrespective of their location. A graphical rendition of this vision is shown alongside
        </p>
        <p>
